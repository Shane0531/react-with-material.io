  ...
  render() {
    ...
    return (
      <div className={classes.section}>
        ...
        <GridContainer justify="center">
          <GridItem xs={12} sm={2}>
            <img src={pwcLogo} alt="..." className={classes.icon} />
          </GridItem>
          <GridItem xs={12} sm={2}>
            <img src={kodeboxLogo} alt="..." className={classes.icon} />
          </GridItem>
          <GridItem xs={12} sm={2}>
            <img src={bighitLogo} alt="..." className={classes.icon} />
          </GridItem>
          <GridItem xs={12} sm={2}>
            <img src={ygLogo} alt="..." className={classes.icon} />
          </GridItem>
        </GridContainer>
      </div>
    );
