          ...
          <GridContainer>
            <GridItem xs={12} sm={12} md={3}>
              <Card plain>
                ...
                <CardFooter className={classes.justifyCenter}>
                  <a
                    href="https://www.linkedin.com/in/brian-kim-936b0635/"
            ...
            <GridItem xs={12} sm={12} md={3}>
              <Card plain>
                ...
                <CardBody>
                  <p className={classes.description}>
                    Both excited and mortified by the future where computers
                    take over our menial data jobs. I warmly welcome it with my
                    guards fully up and ready to fight to the death.
                  </p>
                </CardBody>
                <CardFooter className={classes.justifyCenter}>
                  <a
            ...
            <GridItem xs={12} sm={12} md={3}>
              <Card plain>
                ...
                <CardFooter className={classes.justifyCenter}>
                  <a
                    href="https://www.linkedin.com/in/seonghwan-kim-306497119/"
                    className={classes.link}
                  >
                    <Button
                      justIcon
            ...
            <GridItem xs={12} sm={12} md={3}>
              <Card plain>
                ...
                <CardBody>
                  <p className={classes.description}>
                    Hello, I'm junior web developer and I'm eager to do with
                    something BRAND NEW
                  </p>
                </CardBody>
                <CardFooter className={classes.justifyCenter}>
                  <a
                    href="https://www.linkedin.com/in/wangkwang-lee-679a2016b"
                    className={classes.link}
                  >
                    <Button
                      justIcon
